        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form id="form-edit" modelAttribute="customerContact" method="GET" cssClass="form-horizontal">
                        <div class="row">
                            <div class="col">
                        ...
                        <button id="btnAddCustomer" class="btn btn-primary px-4 mt-3">
                            Gửi liên hệ
                        </button>
                    </form:form>
                </div>
...
<script type="text/javascript">
    function executingAddCustomer(data) {
        $.ajax({
            type: "POST",
            url: "${customerAPI}",
            ...
            error: function (res) {
                console.log(res);
                alert("Error System! Lỗi thêm thông tin, vui lòng thử lại sau.")
            }
        });
    }
